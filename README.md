...
## 設計思想
### なぜ作ったのか
作者がカラオケやボイトレに行く過程で手軽に自分の声の高さを可視化して確認したいと思ったことが起源
自分の声の高さはどこまで出せるのかや思った通りの高さの声を出すことが出来るのかを可視化して練習に活かしたいという思い。

この思いを基にClaudeCodeで技術的なアプローチと技術領域を模索選定した。

### 必須要件
ClaudeCodeに任せる前に必須要件として以下を提示した。
- 声の高さを可視化して、その声の声の高さがどの音なのかを表示。（英語音名）
- 狙った声の高さを出す練習のため、ガイドラインを手動編集。
- 共有モードを作成し、ボイトレに近い形で使用できることを想定
